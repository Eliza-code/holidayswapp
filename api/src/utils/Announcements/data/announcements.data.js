let announcements = [
  ...
  },
  {
    ...
    description: "This cosy apartment is very comfortable for 2 persons.",
  },
  {
    userId: 28,
  ...
  },
  {
    ...
    state: "Florida",
    city: "Miami",
    adress: "Flamingo Boulevard 180",
    type: "Apartment",
    arrivealDate: "2022-02-08",
    departureDate: "2022-02-24",
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/0b/27/12/b3.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/0b/27/12/52.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/0b/27/12/95.jpg",
    ],
    points: 177,
    sleeps: 2,
    bedrooms: 1,
    ...
    description:
      "Your perfect pied-à-terre that's Native American Art Deco Style! Our condo is available for Short & Long Term.",
  },
  {
    userId: 32,
    title: "JOAN's Home",
    ...
    state: "Florida",
    city: "Miami",
    adress: "Ocean Boulevard 400",
    type: "House",
    arrivealDate: "2022-03-18",
    departureDate: "2022-03-28",
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/0a/04/cf/b7.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/0a/04/cf/b1.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/0a/04/cf/58.jpg",
    ],
    points: 250,
    sleeps: 7,
    bedrooms: 3,
    ...
    description:
      "Located on the famous, palm tree lined Alton Road, our classic Mediterranean style home is spacious, open, and calm--seemingly a world away from the hustle and bustle when in actuality, we are just a 15 minute walk to the beach and shops and about a 10 minute drive to the heart of South Beach and Lincoln Road.",
  },
  {
    userId: 33,
    title: "MICK's Home",
    ...
    state: "Florida",
    city: "Miami",
    adress: "Lincol Road 987",
    type: "House",
    arrivealDate: "2022-01-18",
    departureDate: "2022-02-08",
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/07/ed/a6/38.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/07/ed/a6/3a.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/07/ed/a6/3b.jpg",
    ],
    points: 222,
    sleeps: 8,
    bedrooms: 4,
  ...
  },
  {
    ...
    state: "Florida",
    city: "Miami",
    adress: "Washington  333",
    type: "House",
    arrivealDate: "2022-02-09",
    departureDate: "2022-02-19",
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/08/f0/90/78.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/08/f0/90/7f.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/08/f0/90/82.jpg",
    ],
    points: 215,
    sleeps: 6,
    bedrooms: 4,
    ...
    description:
      "Welcome to Casa Blanca! This fantastic home in an idyllic Miami location oozes Coconut Grove charm.",
  },
  {
    userId: 35,
    title: "CARL's Home",
    ...
    adress: "Lincol  1500",
    type: "House",
    arrivealDate: "2022-01-05",
    departureDate: "2022-01-20",
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/06/c2/48/45.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/06/c2/48/4d.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/06/c2/48/4a.jpg",
    ],
    points: 215,
    sleeps: 3,
    bedrooms: 2,
    ...
    description:
      "Unit located in Key Colony in Key Biscayne.It has 2 large bedrooms and 1 baths, pool, gym, private beach, close to restaurants and shops.",
  },
  {
    userId: 36,
    title: "MARIE's Home",
    ...
    state: "Florida",
    city: "Miami",
    adress: "Green Day 1200",
    type: "Apartment",
    arrivealDate: "2022-03-05",
    departureDate: "2022-03-20",
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/07/00/43/8a.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/07/00/43/88.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/07/00/43/8f.jpg",
    ],
    points: 120,
    sleeps: 4,
    bedrooms: 2,
    ...
    description:
      "Excellent location, close to shops, restaurants, entertainment and much more, just a few miles from the beach, downtown Miami, the design district, the wynwood international airport and miami.",
  },
  {
    userId: 37,
    title: "JUANA's place",
    ...
    state: " Comunidad De Madrid",
    city: "Madrid",
    adress: "Paez Vilaro 390",
    type: "House",
    arrivealDate: "2022-02-20",
    departureDate: "2022-03-05",
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/02/9a/f7/7c.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/02/9a/f7/7d.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/02/9a/f7/80.jpg",
    ],
    points: 182,
    sleeps: 4,
    bedrooms: 2,
  ...
  },
  {
    ...
    rating: 3,
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/06/cb/65/b1.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/06/cb/65/af.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-ha-splice-j/06/cb/65/b7.jpg",
    ],
    home_rules: {
      smokersWelcome: false,
      petsWelcome: false,
  ...
  },
  {
    ...
    rating: 4,
    image: [
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/00/31/4a/94.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/00/31/4a/99.jpg",
      "https://media-cdn.tripadvisor.com/media/vr-splice-j/00/31/4a/9e.jpg",
    ],
    home_rules: {
      smokersWelcome: false,
      petsWelcome: false,
